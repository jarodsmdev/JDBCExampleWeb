...
public class SvContacto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Email:" + email + " | Comentarios: " + comments);
        ...
        try {
            ...
            //3. EJECUTAR QUERY
            String querySQL = "INSERT INTO JDBC(email, comentarios) VALUES ('"+ email +"','"+ comments +"');";
            miStatement.executeUpdate(querySQL);
            
            //TODO: IMPLEMENTAR SEGURIDAD EN LA CONSULTA SQL
